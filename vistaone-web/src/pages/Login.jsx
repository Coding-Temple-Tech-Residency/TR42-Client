            ...
            <div>
              ...
              <div className="mt-5 pt-lg-4">
                ...
                <p className="login-hero-text mb-4">
                  Access the client control surface for vendor approval,
                  compliance monitoring, invoice review, and anomaly analytics.
                </p>
            ...
            <div className="login-panel w-100 shadow-lg">
              <div className="mb-4">
                ...
                <p className="login-panel-text">
                  Sign in with your client operator account to continue to the
                  dashboard.
                </p>
              </div>
